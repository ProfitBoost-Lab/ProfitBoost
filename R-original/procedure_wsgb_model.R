...
wsgb.procedure = function(myseed,
                          # seed for reproducibility of the results
                          mydata,
                          # input data
                          pos.covariates,
                          # position (column number of the covariates)
                          delta,
                          # intervention cost
                          conditional,
                          # whether the offer is conditional on renewal
                          loss,
                          # loss function
                          reorder = FALSE,
                          # whether scores should be reordred
                          pi,
                          pi.valid,
                          # individual expected profit lifts used as DV and weights in the profit loss function - not needed for classic loss
                          increment,
                          # used to assess convergence in SGB when computing optimal target size
