...
splitn <- 10
overlap.SGB.WSGB <- overlap.RSGB.WSGB <- overlap.LIFTrm.WSGB <- array(NA, c(B, splitn +
  1)) # customer overlap curves for 10 deciles
...
for (b in 1:B) {
  ...
  targetsize.mylift.valid <- targetsizeoptimization(
    ...
    increment = increment,
    plot = FALSE
  )$targetsize.maxprofit.trimmed / length(myliftproc$valid.data$y) # optimal target size, in percentage
  ...
  mysgbproc <- wsgb.procedure(
    ...
    conditional = conditional,
    loss = "classic",
    # choice between symmetric weighting, left weighting, right weighting, equal weigthing
    reorder = FALSE,
  ...
  targetsize.sgb.valid <- targetsizeoptimization(
    ...
    increment = increment,
    plot = FALSE
  )$targetsize.maxprofit.trimmed / length(mysgbproc$valid.data$y) # optimal target size, in percentage
  ...
  targetsize.rsgb.valid <- targetsizeoptimization(
    ...
    increment = increment,
    plot = FALSE
  )$targetsize.maxprofit.trimmed / length(myrsgbproc$valid.data$y) # optimal target size, in percentage
  ...
  targetsize.wsgb.valid <- targetsizeoptimization(
    ...
    increment = increment,
    plot = FALSE
  )$targetsize.maxprofit.trimmed / length(mywsgbproc$valid.data$y) # optimal target size, in percentage
  ...
  targetsize.wsgb2.valid <- targetsizeoptimization(
    ...
    increment = increment,
    plot = FALSE
  )$targetsize.maxprofit.trimmed / length(mywsgbproc2$valid.data$y) # optimal target size, in percentage
  ...
  targetsize.wsgb3.valid <- targetsizeoptimization(
    ...
    increment = increment,
    plot = FALSE
  )$targetsize.maxprofit.trimmed / length(mywsgbproc3$valid.data$y) # optimal target size, in percentage
