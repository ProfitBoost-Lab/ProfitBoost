...
lift.procedure = function(myseed,
                          # seed to split the dataset in 3 samples
                          mydata,
                          # select the data to be split in 3 samples
                          colnumbers.covariates,
                          # column numbers of predictors excluding w
                          delta,
                          # cost of intervention
                          conditional) {
  # whether the offer is conditional or not
  ...
  {
    rmlift.train = ((1 - r1.train) * m1.train) - ((1 - r0.train) * m0.train) -
      delta
