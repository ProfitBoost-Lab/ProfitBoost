                              ...
                              plot)
{
  ...
  list(
    ...
    # holdout campaign profit at optimal target size (as determined from the validation sample)
    campaign.profit.curve = campaign.profit.curve,
    # campaign profit curve on the test sample
    target.sizes = target.sizes,
    # range of target sizes
    targetsize.maxprofit = targetsize.maxprofit
  ) # optimal target size determined on the validation sample
}
